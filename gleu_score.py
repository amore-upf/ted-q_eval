...
if __name__ == "__main__":
    ref0 = 'Social includes human capital, things like employee engagement and innovation capacity, as well as supply chain management and labor rights and human rights. And governance relates to the oversight of companies by their boards and investors. See, I told you this is the really juicy stuff.'.split()

    ref1 = "Social includes human capital,".split()
    ref2 = "things like employee engagement and innovation capacity,".split()
    ref3 = "as well as supply chain management and labor rights and human rights.".split()
    ref4 = "And governance relates to the oversight of companies by their boards and investors.".split()
    ref5 = "See, I told you this is the really juicy stuff.".split()

    hyp1 = "How is human capital defined?".split()

    print(sentence_gleu([ref1, ref2, ref3, ref4, ref5], hyp1))
    print(sentence_gleu([ref0], hyp1))
    print(sentence_gleu([ref1], hyp1))

    print(bleu.sentence_bleu([ref1, ref2, ref3, ref4, ref5], hyp1))
    print(bleu.sentence_bleu([ref0], hyp1))
    print(bleu.sentence_bleu([ref1], hyp1))